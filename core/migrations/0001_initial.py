    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quinella_result', models.CharField(blank=True, max_length=50, null=True)),
                ('scratched', models.JSONField(default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('CONTENT_EDITOR', 'Content Editor'), ('SUPPORT', 'Support'), ('USER', 'User')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product', models.CharField(choices=[('WIN', 'Win'), ('QUINELLA', 'Quinella'), ('SIX', 'Six')], max_length=20)),
                ('region', models.CharField(choices=[('TR', 'Turkey'), ('INT', 'International')], max_length=10)),
